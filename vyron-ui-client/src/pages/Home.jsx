...
const features = [
  {
    ...
    text: "Install VyronUI and use ready-made, production-grade components instantly.",
  },
  {
    icon: HiSparkles,
  ...
  },
  {
    icon: TbBrandNpm,
    title: "NPM Library",
    text: "Import VyronUI components with a simple npm install command.",
  },
  {
    icon: TbPlayerPlay,
    title: "Live Preview",
...
const steps = [
  {
    ...
    text: "npm install vyron-ui-library-ai to access all prebuilt UI components.",
  },
  {
    n: "02",
...
export default function Home() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("npm install vyron-ui-library-ai");
    setCopied(true);
  ...
  return (
    ...
    >
      ...
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-12 sm:pb-20 text-center">
        ...
        >
          Use prebuilt VyronUI components or generate custom ones with AI. Copy
        ...
        >
          ...
          <div className="font-mono text-[11px] sm:text-[12.5px] leading-6 space-y-0.5 min-w-[280px]">
            <p>
              ...
              <span className="text-[#aaff80]/70">'vyron-ui-library-ai'</span>
