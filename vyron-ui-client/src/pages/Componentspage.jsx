      ...
      Sign in first to browse prebuilt components, live previews, and usage guides.
        ...
        <div className="w-full max-w-md mx-auto text-left space-y-4 mb-8">
          ...
          <div>
            ...
            <CodeBlock code={`npm i vyron-ui-library-ai`} lang="bash" />
          </div>
          ...
          <div>
            ...
            <CodeBlock code={`import { ComponentName } from "vyron-ui-library-ai";`} lang="jsx" />
          </div>
          ...
          <div>
            ...
            <CodeBlock
              code={`import { UserAvatar, PricingCard } from "vyron-ui-library-ai";\n\nexport default function App() {\n  return (\n    <div>\n      <UserAvatar src="/user.png" />\n      <PricingCard title="Pro" price={99} />\n    </div>\n  );\n}`}
              lang="jsx"
            />
          </div>
        </div>
...
function DetailPanel({ component, onBack }) {
  ...
  const importCode = `import { ${component.name} } from "vyron-ui-library-ai";`;
  const usageCode = `import { ${component.name} } from "vyron-ui-library-ai";\n\nexport default function App() {\n  return (\n    <div>\n      <${component.name}${
          ...
          {activeTab === "guide" && (
            ...
            >
              ...
              <div>
                ...
                <CodeBlock code={`npm install vyron-ui-library-ai`} lang="bash" />
              </div>
